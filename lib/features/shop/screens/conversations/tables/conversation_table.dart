...
import 'package:store/features/shop/screens/conversations/tables/conversation_source_row.dart';
import 'package:store/utils/constants/sizes.dart';

class ConversationTable extends StatelessWidget {
  const ConversationTable({super.key});
